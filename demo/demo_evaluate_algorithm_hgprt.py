...
norm_prices, pred_prices, sigma = simulator.trader.hgprt_demo(demo_steps=100, mean_every=1)
simulator.visualizer.plot_prices_with_predictions(norm_prices, pred_prices, sigma)
